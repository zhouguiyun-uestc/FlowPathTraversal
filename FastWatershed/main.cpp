...
int main(int argc, char* argv[])
{
	if (argc < 3)
	{
		...
		cout << "\n [method] can be 'flowdirection','compare','generateOutlets', 'FlowPathTraversal','FlowPathTraversalOpenMP','FastTracingGPU','RegionGrowing','Recursive','PathTracing'" << endl;
	...
	try
	{
		...
		else if (algName == "FlowPathTraversal" || algName=="FlowPathTraversalOpenMP" || algName == "FastTracingGPU" || algName == "RegionGrowing" || algName == "Recursive" || algName == "PathTracing")
		{
			...
			else if (algName == "FastTracingGPU")
